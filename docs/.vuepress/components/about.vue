  ...
  <div class="about">
    <ul class="aboutNav">
      <li
        ...
        :style="cur === item.code ? 'background:#0567f1;color:#fff;' : ''"
        class="aboutNavItem"
      >
        {{ item.title }}
      </li>
    ...
    <div class="aboutContent">
      <div v-show="cur === 'me'">
        <ul class="colors">
          <li class="midnightblue">我出生于江西赣州市会昌县的一个小农村</li>
          <li class="slateblue">没有什么资源</li>
          <li class="blue">学过一些前端</li>
          <li class="deepskyblue">爱过一些路人</li>
          <li class="cornflowerblues">走过很多弯路</li>
          <li class="lightskyblue">看过一些书籍</li>
          <li class="wuwangcaoblue">还在寻找自己</li>
        </ul>
      </div>
      <div v-show="cur === 'tech'">
        <ul>
          ...
          <li><img src="../public/star.png" /><span>微信小程序</span></li>
      ...
      <div v-show="cur === 'book'">
        ...
        <ul>
          <li>
            <img src="../public/star.png" /><span>月光落在左手上 - 余秀华</span>
          </li>
        </ul>
        我喜欢的
        <ul>
          ...
          <li><img src="../public/star.png" /><span>游泳</span></li>
        </ul>
        2022
        <ul>
          <li>
            <img src="../public/star.png" /><span>天堂旅行团 - 张嘉佳</span>
          </li>
        </ul>
        2021
        <ul>
      ...
      <div v-show="cur === 'movie'">
        我喜欢的
        <ul>
          <li><img src="../public/star.png" /><span>长安三万里</span></li>
          <li><img src="../public/star.png" /><span>陪你度过漫长岁月</span></li>
          <li><img src="../public/star.png" /><span>恋恋笔记本</span></li>
          <li>
            <img src="../public/star.png" /><span
              >比悲伤更悲伤的故事 (More than blue)</span
            >
          </li>
          <li><img src="../public/star.png" /><span>肖申克的救赎</span></li>
        </ul>
      </div>
      <!--      <div v-show="cur === 'game'">-->
      <!--        游戏只有和朋友一起玩时才存在意义-->
